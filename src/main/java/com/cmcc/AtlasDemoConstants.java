...
public interface AtlasDemoConstants {
	...
	String HBASE_NAMESPACE_TYPE = "hbase_namespace_zhouzhou";
    String HBASE_TABLE_TYPE = "hbase_table_zhouzhou";
    String HBASE_COLUMN_TYPE = "hbase_column_zhouzhou";
    String HBASE_COLUMN_FAMILY_TYPE = "hbase_column_family_zhouzhou";
    String HBASE_REPLICATION_PROCESS_TYPE = "hbase_replication_process_zhouzhou";
